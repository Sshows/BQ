...
export const metadata: Metadata = {
  title: "Кейсы",
  description:
    "Подборка ключевых кейсов BQ: wedding-съемка, оригинальный сериал и студийный подкаст.",
};
    ...
    <>
      ...
      <main className="bg-bq-black pt-24">
        <section className="section-pad pb-10">
          <div className="container-bq max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-bq-muted">
              ...
              оригинальный сериал и подкаст. Вместе они хорошо показывают, как
              мы снимаем, упаковываем и доводим материал до готового результата.
            </p>
        ...
        <Cases
          ...
          description="От личной истории до сериального контента и студийной записи. Каждая карточка ведет в соответствующее направление сайта."
        />
      </main>
      <Footer />
    </>
